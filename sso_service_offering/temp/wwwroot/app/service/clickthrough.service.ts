...
export class ClickThroughService {
    ...
    orderByAscending(scenarioList: Scenario[]) {
    ...
    getScenarios(clickthroughId: number) {
        var fileName = "";
    ...
    animateClickthrough(clickthroughName: string, scenarioId: number) {
    ...
    animateIntro(scenarioId: number) {
        var animateScenario1_1 = $.scrollorama({ blocks: '#scen1-illus1', enablePin: false });
        var animateScenario1_2 = $.scrollorama({ blocks: '#scen1-illus2', enablePin: false });
